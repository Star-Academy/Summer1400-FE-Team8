  ...
  validateForm = (form: any)=> {
    ...
    if(form.password){
        // checkPasswordStrength(form.password,passErrorId);
          ...
          if ((<HTMLInputElement>document.getElementById(errorIds.passErrorId)).style.color === "red")
          {
...
checkPasswordStrength = (code:any,pass_error:any)=>{
    ...
    (<HTMLDivElement>document.getElementById(pass_error)).style.color = color;
    (<HTMLDivElement>document.getElementById(pass_error)).innerHTML = strength;
